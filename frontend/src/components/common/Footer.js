        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Your trusted platform for short-term accommodation bookings. 
              Connecting hosts and guests for memorable stays.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/faqs" className="text-gray-400 hover:text-white transition-colors text-sm">
                  FAQs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/community-guidelines" className="text-gray-400 hover:text-white transition-colors text-sm">
