    ...
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden sticky top-0 z-40 text-white shadow-md" style={{backgroundColor: '#4E7B22'}}>
        <div className="flex items-center justify-between px-4 py-3 sm:px-6">
          <div>
            <p className="text-lg font-semibold leading-tight sm:text-xl">Admin Panel</p>
            <p className="text-xs text-green-100 sm:text-sm">Welcome, {user?.firstName || 'Admin'}</p>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 pt-0 lg:pt-0">
        <div className="flex-1 w-full max-w-7xl mx-auto px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
          <PageTransition>
            {children}
          </PageTransition>
        </div>
