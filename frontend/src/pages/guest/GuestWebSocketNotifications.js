...
import { BellIcon, CheckIcon, TrashIcon, CheckCircleIcon } from '@heroicons/react/24/outline';

const GuestWebSocketNotifications = () => {
...
export default GuestWebSocketNotifications;
