    ...
    if (notification.subjectId) {
      switch (notification.type) {
        ...
        case 'booking_reminder':
          navigate(`/admin/bookings/${notification.subjectId}`);
          break;
        case 'property':
          navigate(`/admin/properties/${notification.subjectId}`);
          break;
        case 'user':
          navigate(`/admin/users/${notification.subjectId}`);
          break;
        default:
          break;
      }
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start space-x-3">
            ...
            <div className="max-w-2xl">
              <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Admin Notifications</h1>
